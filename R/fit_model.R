...
#' @param drop_non_numeric Should non numeric columns be dropped? Defaults to FALSE
...
#' @export
fit_model <- function (df=NULL, yname=NULL, xname=NULL, modeltype=NULL,drop_non_numeric=FALSE,...){
...
fit_models <- function (df=NULL,yname=NULL, xname=NULL, modeltype=NULL,drop_non_numeric=FALSE,
                        ...){

if(!length(yname)>1) stop("fit_models is used for several yname, use fit_model for single predictors")
