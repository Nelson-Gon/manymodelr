...
model_attrs_list <- list(call=model_call,
                         aic = AIC(model_object,...), bic = BIC(model_object,...),
                       log_lik= logLik(model_object,...),
                       deviance = deviance(model_object,...),
                       df.resid= df.residual(model_object,...),
                      coeffs = coef(model_object,...) , predictors = predictor_var,
                      residuals = residuals(model_object,...),
                      resids = residuals(model_object,...),
