...
```{r}
fit_model(iris,"Sepal.Length","Petal.Length","lm")
...
To show significance of the results instead of the correlations themselves, we can set `show_value` to `FALSE` and set `show_signif` to `TRUE` as shown below. By default,
...
#plot_corr(res, x="Other_Var", y="Comparison_Var",
 #         plot_style = "squares",
  #        show_value = FALSE, show_signif = TRUE,
   #       colour_by = "p.value",
